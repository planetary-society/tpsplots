...
|-------|------|---------|-------------|
| `categories` | any (template ref) | — | Category labels for x-axis |
| `groups` | list[[GroupConfig](#groupconfig) or dict] | — | List of group configurations |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `colors` | str or list[str] | — | Override colors for groups |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `labels` | str or list[str] | — | Legend labels for each group (overrides group label) |
...
| `stacked_values` | list | — | Additional values to stack on last category |
| `stacked_color` | str | — | Color for stacked portion |
